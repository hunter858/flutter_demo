        ...
        child: Column(
          children: [
            Flex(
              ...
              children: [
                Expanded(flex:1, child: redBox,),
                Expanded(flex:2, child: greenBox,),
                Expanded(flex:3, child: orangeBox,),
                ]
              ),
            ...
            Flex(
              direction: Axis.horizontal,
              children: [
                Expanded(flex:2, child: redBox,),
                Expanded(flex:2, child: greenBox,),
                Expanded(flex:2, child: orangeBox,),
                ]
            ),
            const Padding(padding: EdgeInsets.only(top: 10,bottom: 10)),
            Flex(
            ...
            Flex(
              ...
              children: [
                Expanded(flex:3, child: redBox,),
                Expanded(flex:2, child: greenBox,),
                Expanded(flex:1, child: orangeBox,),
                ]
            ),
            const Padding(padding: EdgeInsets.only(top: 10,bottom: 10)),
            SizedBox(
