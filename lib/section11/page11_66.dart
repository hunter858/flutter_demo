...
class Page11_66 extends StatefulWidget with BasePage {
  const Page11_66({super.key});
  static String routePath = 'page11_66';

  @override
  State<Page11_66> createState() => _Page11_66State();
}

class _Page11_66State extends State<Page11_66> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Page11_66 Route'),
      ),
      body: Container(
        child: Column(
          children: [
