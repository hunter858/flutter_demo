...
class Page6_23 extends StatefulWidget with BasePage {
  static String routePath = 'Page6_23';
  const Page6_23({super.key});

  @override
  State<Page6_23> createState() => _Page6_23State();
}

class _Page6_23State extends State<Page6_23> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Page6_23 Route'),
      ),
      body: Container(
        child: Column(
          children: [
